...
System.out.println("This is the gas calclulator. This doohickey will tell you if you can drive a hundred miles!");
//String gallonString = JOptionPane.showInputDialog(null, "How much gas in gallons do you have?");
System.out.println("how much gas in gallons do you have?");
String gallonString = scan.nextLine();
...
String efficiencyString = scan.nextLine();
